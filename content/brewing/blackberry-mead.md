...
excerpt: "A deep purple blackberry melomel fermented dry then back-sweetened and bottle-pasteurized. Lessons from a first attempt: take gravity readings and weigh honey."
...
brewData:
  ...
  primaryEndDate: '2026-03-25'
  secondaryStartDate: '2026-03-25'
  secondaryEndDate: '2026-04-04'
  bottlingDate: '2026-04-24'
  drinkingReadyDate: '2026-04-24'
...
ingredients:
  ...
  - "1 packet Red Star Premier Cote Des Blancs yeast"
  - "1/4 tsp Fermaid K"
  - "Water to volume"

steps:
  - title: "Prepare the Must"
    description: "This was a rushed brew. I mixed honey with water to make a 1-gallon must, then added 2 lbs of fresh blackberries — not frozen this time — to a mesh bag, smashing them just a little to break open the cell walls. I was trying to put the batch together in very little time and forgot to take an original gravity reading. Without that OG I have no way to calculate the final ABV, which is one of the biggest lessons I took away from this batch."
  ...
  - title: "Ready to Drink"
    description: "We tasted a sample after bottling and it was way too sweet — the honey overshoot was more than expected. Rather than dumping it, I'm letting the bottles sit for an extended time to see if the sweetness mellows with age. If it balances out, great. If not, I'll count this as a learning batch and try again with a lighter hand on the back-sweetening next time."
---

## Lessons for Next Time

This batch taught me several things I will do differently next time:

- **Take an original gravity reading.** Without an OG I cannot calculate ABV, which is useful information for labeling and sharing the recipe.
- **Measure back-sweetening additions.** Eyeballing the honey left me with no reproducible data. Next batch I will weigh the honey before and after adding it.
- **Keep better yeast notes.** I recorded Red Star Premier Cote Des Blancs for this batch, but on future batches I will also write down the exact nutrient schedule and any other additions.
