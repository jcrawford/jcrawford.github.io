...
**Step 4: Calcium + Chloride + Sulfate (remaining).**
After steps 1–3, three ions are already partially filled:
...
1. **Buy 1 gallon of distilled water** from the grocery store
2. **Weigh each salt** on a 0.01g digital scale — set them out in small dishes
3. **Dissolve all salts** in the distilled water and stir until fully dissolved
4. **Test pH** — it should be around 6.5–7.5 (distilled water plus minerals). If below 6.0, add a pinch more bicarbonate. If above 7.5, don't worry — the honey will bring it down
5. **Add honey** and mix thoroughly
6. **Test pH again** — now you're looking for 3.4–3.8. Adjust with acid blend (lower) or bicarbonate (raise) if needed
7. **Pitch yeast** and proceed with your normal fermentation process
