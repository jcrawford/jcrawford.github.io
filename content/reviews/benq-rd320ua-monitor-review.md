...
review:
  ...
  price: $749.99
  brand: BenQ
  productUrl: 'https://www.benq.com/en-us/monitor/programming/rd320ua/buy.html'
---
...
![This is what text looks like on my Dell side displays — soft, slightly fuzzy, and nowhere near as crisp as the BenQ.](/images/content/reviews/benq-rd320ua-monitor-review/dell-text-clarity.jpg)
...
![This is what text looks like on the BenQ RD320UA — razor-sharp, crisp, and a night-and-day difference from the Dell side displays.](/images/content/reviews/benq-rd320ua-monitor-review/benq-text-clarity.jpg)
...
<p>My <a href="/reviews/voyager-keyboard">Voyager Keyboard</a> and mouse are connected directly to the monitor, so when I switch inputs the keyboard and mouse go with it — that is the whole point of the built-in KVM. One keyboard, one mouse, two machines, and the monitor handles the handoff.</p>
