...
**Mac mode**: Command and Option keys in correct positions, Mac-specific media keys
**Windows mode**: Windows and Alt keys positioned correctly
...
1. **Bluetooth**: Connect up to 3 devices, switch between them with key combination
2. **USB-C wired**: Zero latency, always reliable
3. **2.4GHz wireless**: Low latency wireless (dongle included)
...
**Keychron Q1**: Wired, slightly better build, $169
**GMMK Pro**: Similar features, slightly better keycaps, $169
**Logitech MX Mechanical**: Premium, expensive, $169
**Royal Kludge RK84**: Budget alternative, $60
**Keychron K8 (non-Pro)**: No QMK/hot-swap, $79
