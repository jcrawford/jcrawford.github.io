...
review:
  ...
  cons:
    - Website only offered a single pickup location for this vehicle type
    - Vestibule counter in the garage was closed with no signage
    - Three-hour wait in line with a pre-paid reservation
    - Deposit denied on debit card despite customer service confirming it was allowed
    - Vehicle was not ready at the reserved pickup time — told to wait another three hours
    - No communication about delays or issues at any point in the process
  price: '$1,600 (2-week rental)'
  brand: Budget
  productUrl: 'https://www.budget.com/'
---
...
I've written a full [review of the 2026 Ford Transit 15-Passenger Van](/reviews/ford-transit-15-passenger-van-review/) separately if you want to read about the vehicle itself — it's a great van. The rental experience was the problem.
...
![Fuel gauge at dropoff showing tank was full](/images/content/reviews/budget-auto-rental-process/fuel-gauge.jpg)
...
I was told to expect an email from this department. Up until this point, I have not received any such email. Thankfully, I do have a claim number that I can use to get updates on the case. I called today to get an update, but they couldn't find anything under my claim number. They were able to look it up through my rental agreement instead, and I was told to wait 5–7 days for a response. So for now, I'm stuck calling back every few days to check on the status myself.
