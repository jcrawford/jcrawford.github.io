...
featuredImage: /images/content/spacex-cursor-60b-acquisition/featured.png
tags:
  - ai
  - development
...
If you blinked this week, you might have missed one of the biggest tech acquisitions in recent memory. SpaceX — fresh off the most anticipated IPO in years — has [officially exercised its option to acquire Cursor](https://techcrunch.com/2026/06/16/spacex-to-acquire-cursor-for-60b-in-stock-days-after-blockbuster-ipo/) in an all-stock deal valued at $60 billion. The deal is expected to close in Q3 2026.

This isn't a rumor or a term sheet that might quietly disappear. SpaceX [filed the agreement with the SEC](https://www.sec.gov/Archives/edgar/data/1181412/000162828026043411/spaceexplorationtechnologi.htm), and Elon Musk's company [announced it publicly on X](https://x.com/SpaceX/status/2066873915717136548). The structure has been in place since April, when SpaceX secured the right to either buy Cursor for $60 billion or walk away and pay a staggering $10 billion breakup fee. The IPO is done. The option has been exercised. This is happening.
...
SpaceX merged with xAI earlier this year, bringing Musk's AI efforts directly under the SpaceX umbrella. The combined entity has been vocal about wanting to compete with OpenAI and Anthropic in enterprise AI — and about being frustrated that it's been behind. Musk himself [reportedly expressed frustration](https://www.ft.com/content/e5fbc6c2-d5a6-4b97-a105-6a96ea849de5) with xAI's lagging coding product. Meanwhile, [Ars Technica notes](https://arstechnica.com/ai/2026/06/spacex-will-acquire-coding-tool-cursor-to-compete-with-anthropic-openai/) that Cursor had strong talent and a real product but was bottlenecked on compute, while SpaceX had the capacity but lacked competitive coding models. Two companies with complementary weaknesses, meeting in the middle.
...
The companies had already been working together. In April, xAI struck a deal to rent data center capacity to Cursor, and the two teams [began jointly training models](https://interestingengineering.com/culture/spacex-cursor-acquisition-coding-platform-60-billion) — including Grok Build, xAI's coding and knowledge work model. That collaboration foreshadowed the deeper tie-up that's now official.
...
Cursor's biggest constraint has always been compute. The team [said so themselves](https://arstechnica.com/ai/2026/06/spacex-will-acquire-coding-tool-cursor-to-compete-with-anthropic-openai/) earlier this year: their growth was bottlenecked on GPU capacity. SpaceX, on the other hand, has been building massive data center infrastructure and has already struck deals with Anthropic and Google for compute sharing — deals that include favorable termination clauses if SpaceX's own AI efforts take off.
...
SpaceX's [SEC filing](https://www.sec.gov/Archives/edgar/data/1181412/000162828026043411/spaceexplorationtechnologi.htm) explicitly noted that Cursor's coding workflows generate "valuable developer interaction data, including coding prompts, iteration cycles and software architecture decisions" that can improve model training. That flywheel — better model → better suggestions → more usage → more training data → better model — is the kind of compounding advantage that could make this acquisition look cheap in hindsight.
...
- [SpaceX acquires Cursor in $60B stock deal — Interesting Engineering](https://interestingengineering.com/culture/spacex-cursor-acquisition-coding-platform-60-billion)